...
export default class HttpService {
    ...
    has(name){if (typeof name === 'string' && name){return this.#api.has(name);}return false;}
    get(name){if (this.has(name)){return this.#api.get(name);}return null;}
    set(name, client){if (typeof name === 'string' && name){this.#api.set(name, client);}return this;}
    delete(name){if (this.has(name)){this.#api.delete(name);return this;}}
    clear(){this.#api.clear();return true;}
}
