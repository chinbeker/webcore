...
export default class ComponentService {
    ...
    async styles(style){
        if (typeof style === "string"){
            ...
            sheet.replaceSync(ComponentStyles.compress(style));
            ComponentStyles.base.push(sheet);
        }
    }
